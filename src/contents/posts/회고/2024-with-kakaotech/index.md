...
난 프로그래밍 못지않게 글쓰기에 몰입할떄가 가장 즐겁다. **글쓰기는 머리 밖으로 분산된 생각들을 한 곳에 모아 정교화할 수 있고, `메타인지` 활성화에도 아주 큰 도움이 된다. 또한 인간은 망각의 동물이다. 이를 해결할 수 있는것이 글쓰기다. 예전에 기록했던 내용을 다시 확인하여 휘발된 기억들을 빠르게 복기하며 내가 알아낸 지식들을 장기화시킬 수 있다.**
...
본 과정은 우아한테크코스, 네이버 부스트캠프, 소프티어, SSAFY 등 기업에서 운영하는 교육 코스 중 하나이다. 카카오에서도 교육 코스를 본격적으로 운영하기 시작했다.
