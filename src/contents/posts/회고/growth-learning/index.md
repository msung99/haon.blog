...
다음주부터 카카오테크에 합류하기전, 지금까지의 내 학습법은 어떠했는지, 어떤 부분을 보완할 것인지 회고하려고 한다. 이전부터 꼭 자세히 회고하고 싶었던 내용인데, 그간 여유가 없었던지라 드디어 적을 수 있게 되었다.
...
이 환경과 학습에 있어 카카오테크 코스를 난 적극 이용해보고자 한다. 🙂 **아직 본 코스가 시작되지 않았으므로, 향후 더 가꾸어진 나만의 효과적인 학습법을 다루도록 하겠다.** 애당초 지금 시점에 완벽한 학습법을 가꾸지 않아도 괜찮다고 생각한다. 코치님들에게 꾸준히 면담을 신청하고, 많은 가르침을 받으며 더 빠르게 성장하고 싶다.

### 블로깅과 세컨드 브레인을 더 효과적으로 활용하기 위해
